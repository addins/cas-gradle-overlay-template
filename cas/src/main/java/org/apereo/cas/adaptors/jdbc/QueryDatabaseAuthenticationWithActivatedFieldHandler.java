 ...
 * @since 3.0.0
 */
public class QueryDatabaseAuthenticationWithActivatedFieldHandler extends AbstractJdbcUsernamePasswordAuthenticationHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryDatabaseAuthenticationWithActivatedFieldHandler.class);
    ...
    private final String fieldActivated;

    public QueryDatabaseAuthenticationWithActivatedFieldHandler(final String name, final ServicesManager servicesManager,
                                                                ...
                                                                final String fieldActivated, final Map<String, String> attributes) {
    ...
    protected HandlerResult authenticateUsernamePasswordInternal(final UsernamePasswordCredential credential, final String originalPassword)
        ...
        try {
            ...
            if (StringUtils.isNotBlank(this.fieldActivated)) {
                final Object dbActivated = dbFields.get(this.fieldActivated);
                if (dbActivated == null || (Boolean.FALSE.equals(BooleanUtils.toBoolean(dbActivated.toString())) || dbActivated.equals(Integer.valueOf(0)))) {
                    throw new AccountDisabledException("Account has been deactivated");
                }
            }
